...
Official Android builds of Screen Awake. The current preview is `0.1.4-preview`, supports Android 13+, and is distributed together with a SHA-256 checksum and machine-readable `latest.json` metadata.
